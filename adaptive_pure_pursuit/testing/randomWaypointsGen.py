...
path = Path()
path_pub = rospy.Publisher("/random_waypoints", Path, queue_size=10)
...
if __name__ == "__main__":
    ...
    # rate.sleep()
    tock = time.time()
    print("Number of waypoints: ", len(path.poses))
